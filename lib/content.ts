...
export const features: Feature[] = [
  ...
  },
  {
    ...
    body: "Sign in with Google on both devices; Servey only ever pairs your Mac with your iPhone or iPad. On the remote path your screen video is peer-to-peer and end-to-end encrypted — it never touches a server. The cloud only brokers the initial handshake.",
    bullets: ["Account-scoped device pairing", "Video never touches a server", "Device registration & approval"],
    privacy: true,
  },
  {
    index: "06",
...
export const comparison = {
  ...
  rows: [
    ...
    },
    {
      ...
      servey: "P2P — video never touches a server; cloud only brokers the handshake",
    },
    {
      theme: "Terminal",
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Servey pairs only your Mac with your own iPhone or iPad, scoped to your account. On the remote path your screen video is peer-to-peer and end-to-end encrypted — it never touches a server. The cloud is only used to broker the initial handshake.",
  },
  {
